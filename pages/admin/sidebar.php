<div id="offcanvas-menu" class="offcanvas offcanvas-start bg-body show visible" tabindex="-1" data-bs-backdrop="false">
    <div class="offcanvas-header"><a class="link-body-emphasis d-flex align-items-center me-md-auto mb-3 mb-md-0 text-decoration-none" href="/"><svg class="bi bi-bootstrap-fill me-3" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="font-size: 25px;">
            ...
            </svg><span class="fs-4">CulThe</span></a><button  data-bs-dismiss="offcanvas hide"></button></div>
...
<!-- <div class="side-bar">
    ...
    <div class="side_bar__main">
        <ul class="side_bar__list">
            <li class="side_bar__item">
                <a href="" class="side_bar__link">
